...
class Strats_Analytics(object):
	...
	def run_tape_extension_procedure(self):
		...
		# print "echo"
		# for item in self.datatype_dict.keys(): print item
		# print "echo"
#
		for index, row in self.dimensions_settings.iterrows():
			...
			# print col
			# print self.datatype_dict.keys()
			# print self.datatype_dict[col]
			
			datatype = self.datatype_dict[col]

			# datatype = self.datatype_dict[u'产品名称']
